  ...
  return (
      ...
      <div className="box gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="mt-4 md:mt-0">
          ...
          <button type="button" class="botaoComunidade text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-xl px-5 py-2.5 text-center me-2 mb-2"> <a href="https://drive.google.com/file/d/10qrSNyxho7g155mY4meg63-bR429PiCY/view?usp=sharing" target="_blank" rel="noopener noreferrer">Baixar Modpack</a> </button>
          <button type="button" class="botaoComunidade text-white bg-gradient-to-r from-blue-800 to-blue-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-xl px-5 py-2.5 text-center me-2 mb-2"> <a href="https://drive.google.com/file/d/17MqzIVvUJpUdyZr88qTSCccT4Oz-z3Mx/view?usp=sharing" target="_blank" rel="noopener noreferrer">Baixar Patch</a> </button>
        </div>
      </div>
