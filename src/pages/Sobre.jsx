export default function Sobre() {
  return (
    ...
    <div className="relative min-h-screen">
      ...
      >
        ...
        <div className="p-0 flex flex-col items-center justify-center text-center">
          <img className="h-112 max-w-3xl rounded-lg shadow-2xl dark:shadow-gray-800 mb-8" src="ohara-sobre.png" alt="image description"></img>
        ...
        <figure className="max-w-screen-md mx-auto text-center">
          ...
          <blockquote>
             ...
             <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
                  <img className="w-26 h-26 rounded-full" src="/squirtle-icon.png" alt="profile picture"/>

              <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-white dark:divide-white">

                  <cite className="pe-3 text-3xl font-mono text-gray-900 dark:text-white">Jean Caetano</cite>
                  <cite className="ps-3 text-sm font-mono text-gray-500 dark:text-white">Roteirista</cite>
    ...
    <div className="p-0 flex flex-col items-center justify-center text-center">
      <section className=" ">
            <div className="py-2 px-2 mx-auto max-w-screen-sm lg:py-16 lg:px-6 ">
              <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                <h1 className="text-3sxl font-mono italic   leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white texto-com-borda texto-com-borda">NOSSA EQUIPE</h1>
              </div> 
