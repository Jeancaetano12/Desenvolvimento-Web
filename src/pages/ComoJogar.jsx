    ...
    <div className="relative min-h-screen">
      ...
      <div className="flex flex-col p-4 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap pb-16 pt-4 relative z-10">
          {/*Div da esquerda*/}
          <div className="p-2 flex flex-col items-center justify-center text-center">
            <img src="Pousada2.png" alt="Spawn" className=" box rounded-lg mb-4 shadow-2xl dark:shadow-gray-800"/>
            <img src="NPC1.png" alt="NPC1.png" className=" box rounded-lg mt-4 shadow-2xl dark:shadow-gray-800"/>
          </div>
          {/*Div da direita*/}
          <div className="p-2 flex flex-col items-center justify-center text-center">
            <img src="Estalagem.png" alt="Pousada" className=" box rounded-lg mb-4 shadow-2xl dark:shadow-gray-800"/>
            <img src="Estalagem2.png" alt="Quartos" className=" box rounded-lg mt-4 shadow-2xl dark:shadow-gray-800"/>
          </div>
        </div>
        ...
        <figure className="max-w-screen-md mx-auto text-center">
          ...
          <blockquote>
            <p className="box text-2xl italic font-medium text-gray-900 dark:text-white text-shadow-lg/55">
          ...
          <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
            <img className="w-26 h-26 rounded-full" src="squirtle-icon.png" alt="profile picture"></img>
          <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
            <cite className="box pe-3 font-mono text-gray-900 dark:text-white">Jean Caetano</cite>
            <cite className="box ps-3 font-mono text-sm text-gray-500 dark:text-white">Roteirista</cite>
          </div>
          </figcaption>
        </figure>
        </section>
