  ...
  return (
    ...
    <div className="relative min-h-screen">
      ...
      >
        ...
        <div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-8 flex justify-center items-center">
        ...
        <hr class="w-320 h-1 mx-auto my-4 bg-white border-0 rounded-sm dark:bg-white"></hr>
      ...
      <div className="p-4 flex flex-col items-center justify-center text-center">
        <div className="p-0 flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-8 mb-8 text-lg font-mono text-gray-900 lg:text-xl sm:px-16 lg:px-48 dark:text-white text-shadow-lg/55">
